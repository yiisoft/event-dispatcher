...
/**
 * Provider of event dispatchers for target object class names. If the dispatcher is not defined, it will be created
 * using the listeners defined in the target object class's attributes.
 */
